...
export const selectTriggerVariants = cva(
  'flex min-h-11 w-full items-center justify-between rounded-input border border-border/80 bg-gradient-to-b from-card to-card-subtle px-3 py-2.5 text-body shadow-sm ring-offset-background transition-[border-color,box-shadow] duration-motion-normal ease-motion-out placeholder:text-muted-foreground focus:border-primary/35 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:min-h-10 md:py-2 [&>span]:line-clamp-1',
)
...
export const selectItemVariants = cva(
  'relative flex min-h-11 w-full cursor-default select-none items-center rounded-sm py-2 pl-8 pr-3 text-body outline-none transition-colors duration-motion-fast ease-motion-out focus:bg-accent/12 focus:text-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50 md:min-h-10 md:py-1.5 md:pr-2',
)
