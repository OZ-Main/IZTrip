...
export const themeSwitcherButtonVariants = cva(
  'relative z-[1] inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-transparent p-0 text-caption font-semibold transition-colors duration-motion-fast ease-motion-out lg:min-h-8 lg:h-auto lg:w-auto lg:min-w-0 lg:px-2.5 lg:py-1',
  {
    variants: {
      state: {
